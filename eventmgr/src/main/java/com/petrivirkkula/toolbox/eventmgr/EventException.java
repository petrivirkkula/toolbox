...
public class EventException extends Exception
{
	 ...
	 * @param message	exception messages
	 */
	public EventException(Event causingEvent, String message) {
		super(message);
	 ...
	 * @param cause		nested exception
	 */
	public EventException(Event causingEvent, Throwable cause) {
		super(cause);
		this.causingEvent = causingEvent;
	}
	 ...
	 * @param cause		nested exception
	 */
	public EventException(Event causingEvent, String message, Throwable cause) {
		super(message, cause);
		this.causingEvent = causingEvent;
	}
