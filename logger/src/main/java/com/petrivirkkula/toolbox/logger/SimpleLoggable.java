...
public class SimpleLoggable extends AbstractLoggable implements ExtendedLoggable
{
	...
	/**
	 * Simple loggable with message parameter.
	 * 
	 * If the <code>message</code> is instance of <code>ExtendedLoggable</code>, it is passed
	 * to parent class <code>AbtractLoggable</code>.
	 * 
	...
	/**
	 * Simple loggable with exception and message parameters.
	 * 
	 * The <code>exception</code> is passed to parent class <code>AbtractLoggable</code>.
	 * 
